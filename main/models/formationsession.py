...
class FormationSession(BaseModel):
    ...
    training_site = models.ForeignKey(to=Address, on_delete=models.SET_NULL, blank=True,null=True)
    ...
    teacher_name = models.ForeignKey(to=User, limit_choices_to={'groups__name': "teacher"}, on_delete=models.SET_NULL, blank=True,null=True)
